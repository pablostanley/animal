  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mt-2 max-w-2xl text-sm leading-6 text-black/60 dark:text-white/60">
        Use the <code className="rounded bg-white/10 px-1.5 py-0.5">an</code> prop to apply preset tokens. Most
        presets are phase-scoped like <code className="rounded bg-white/10 px-1.5 py-0.5">hover:lift</code>.
      </p>
